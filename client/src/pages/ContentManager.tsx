      ...
      <header className="bg-white border-b border-[#E0E7FF] sticky top-0 z-40">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="font-bold text-xl text-[#2C2C2C]">Content Manager</h1>
              <p className="text-xs text-[#7A7A7A]">Manage courses, modules & batches</p>
            </div>
          </div>
          <Button variant="outline" className="border-[#E0E7FF]">Back to Admin</Button>
        </div>
      </header>
